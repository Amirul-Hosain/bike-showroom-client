...
const Banner = () => {
    return (
        <div style={{ backgroundColor: 'rgb(6, 5, 26)' }}>
            <div className='row'>
                <div style={{ color: 'white', width: '550px', display: 'flex', flexDirection: 'column', margin: 'auto' }} className='col-lg-7 col-md-6 col-12'>
                ...
                <div className='col-lg-5 col-md-6 col-12'>
                    <img width='100%' height='650' src={one} alt="" />
                </div>
            </div>
        </div>
    );
